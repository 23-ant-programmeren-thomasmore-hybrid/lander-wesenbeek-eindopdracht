                        ...
                        <div className="lg:max-w-lg">
                            ...
                            <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                ...
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure
                                ...
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline">Ac tincidunt sapien vehicula erat auctor pellentesque
