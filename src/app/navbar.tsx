        ...
        <nav className="w-full mx-auto z-10 fixed">
            <div className="grid grid-cols-3 gap-x-8">
                <nav className=" grid grid-cols-4">
                    ...
                    <a className="bg-custom-1 p-3 border-2 border-solid hover:border-none border-slate-400 text-center" href="contact">Contact</a>
                    <a className="bg-custom-1 p-3 border-2 border-solid hover:border-none border-slate-400 text-center rounded-br-lg" href="Basis_CV.pdf">CV</a>
                </nav>
            </div>
        </nav>
    )
